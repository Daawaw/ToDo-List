	...
	<body>
		<div class="navbar navbar-inverse navbar-fixed-top">
	      <div class="navbar-inner">
	        <div class="container-fluid">
	          ...
	          <a class="brand" href="">Makarovski's Awesome TODO List</a>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="span12">
					<br>
					<h1 class="text-center" style = "font-family:new courier;color:black;font-size:34px;">Register For Makarovski's Awesome TODO List</h1><hr><br>
				</div>
